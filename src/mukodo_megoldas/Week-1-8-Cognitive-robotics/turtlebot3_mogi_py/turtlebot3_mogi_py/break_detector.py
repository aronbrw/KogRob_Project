...
class ImageSubscriber(Node):
    ...
    def process_image(self, img):
        ...
        self.get_logger().info(f"UP:{upper_pixels} MID:{middle_pixels} LOW:{lower_pixels} BREAK:{break_detected}")
        #######################
    ...
    def detect_break(self, binary_img):
        ...
        line_up = upper_pixels > 1300
        line_mid = middle_pixels > 2000
        line_low = lower_pixels > 3000

        break_detected = line_low and line_up and not line_mid
